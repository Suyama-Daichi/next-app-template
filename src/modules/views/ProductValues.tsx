...
function ProductValues() {
  return (
    <Box component="section" sx={{ display: 'flex', overflow: 'hidden', bgcolor: 'secondary.light' }}>
      <Container sx={{ my: 15, display: 'flex', position: 'relative' }}>
        <Box
          component="img"
          ...
          <Grid item xs={12} md={4}>
            <Box sx={item}>
              ...
              <Typography variant="h5">
                From the latest trendy boutique hotel to the iconic palace with XXL pool, go for a mini-vacation just a
                few subway stops away from your home.
              </Typography>
            </Box>
          </Grid>
          <Grid item xs={12} md={4}>
